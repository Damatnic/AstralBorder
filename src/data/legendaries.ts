...
export const legendaryData: LegendaryItem[] = [
  ...
  // Enhancements
  { category: "Enhancements", tier: "S", name: "Z-Initator", effect: "Combines Atlas effects: Tracker Antenna + Sure Shot; sustained fire rate + automatic target acquisition", dropLocation: "Primordial Vaults, Elite Enemies", requirements: "Character Level 15+", manufacturer: "Atlas", forClass: "All", analysis: "Best legendary enhancement; merges two manufacturer effects for aggressive assault builds; perfect synergy." },
  { category: "Enhancements", tier: "S", name: "Bulwark Enhancer", effect: "+100% weapon shield capacity for Hyperion-licensed weapons", dropLocation: "Red Chests, Bosses", requirements: "Character Level 15+", manufacturer: "Hyperion", forClass: "All", analysis: "Massive shield boost for defensive playstyles; great for tank builds." },
  { category: "Enhancements", tier: "S", name: "Explosive Amplifier", effect: "+30% Critical Damage, +15% Status Effect Damage, Firmware: Explosive chain reactions", dropLocation: "Abandoned Auger Mines", requirements: "Character Level 15+", manufacturer: "Torgue", forClass: "All (esp. Rafa)", analysis: "Top-tier for explosive and crit builds; stacks with gear sets." },
  { category: "Enhancements", tier: "A", name: "Precision Calibrator", effect: "+30% Accuracy, +30% ADS Proficiency, +15% Status Effect Chance", dropLocation: "Ripper Drill Sites", requirements: "Character Level 15+", manufacturer: "Jakobs", forClass: "All (crit builds)", analysis: "Perfect for precision weapons; improves consistency." },
  { category: "Enhancements", tier: "A", name: "Velocity Booster", effect: "+xx% Reload Speed, +15% Weapon Status Effect Damage, Firmware: Action Fist", dropLocation: "Order Bunkers", requirements: "Character Level 15+", manufacturer: "Vladof", forClass: "All", analysis: "Great for high fire rate builds; pairs well with fast weapons." },
  { category: "Enhancements", tier: "A", name: "Elemental Conductor", effect: "+15% Status Effect Chance, +15% Status Effect Damage, Dual element procs", dropLocation: "World Drop", requirements: "Character Level 15+", manufacturer: "Maliwan", forClass: "All (esp. Vex)", analysis: "Essential for elemental builds; maximizes DoT damage." },
  { category: "Enhancements", tier: "B", name: "Tracking Module", effect: "+30% Accuracy, Automatic target tracking on sustained fire", dropLocation: "Elite Enemies", requirements: "Character Level 15+", manufacturer: "Atlas", forClass: "All", analysis: "Good for beginners; makes aiming easier." },
  { category: "Enhancements", tier: "B", name: "Overshield Generator", effect: "+xx% Shield Recharge Rate, Chance to generate overshield on kill", dropLocation: "Red Chests", requirements: "Character Level 15+", manufacturer: "Hyperion", forClass: "All", analysis: "Decent survivability boost; outclassed by Bulwark." },
  { category: "Enhancements", tier: "C", name: "Basic Amplifier", effect: "+15% Weapon Status Effect Damage", dropLocation: "Common Drop", requirements: "Character Level 15+", manufacturer: "All", forClass: "All", analysis: "Entry-level enhancement; replaced quickly." },
  { category: "Enhancements", tier: "C", name: "Firmware Starter", effect: "Firmware: Airstrike (0/3)", dropLocation: "Common Drop", requirements: "Character Level 15+", manufacturer: "All", forClass: "All", analysis: "Needs gear set stacking to be useful; weak alone." }
];
